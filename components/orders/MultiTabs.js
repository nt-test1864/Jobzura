        ...
        <div className="tableContainer ordersTableGrid">
            ...
            {agreements?.map((agreement, index) => (
              <>
                {agreement.name.State === "in progress" && (
                  <OrdersRows key={index} agreement={agreement} showModal={showModal} setShowModal={setShowModal} />
                )}
              </>
            ))}
          </div> */}
          ...
          <TabPanel>
              ...
              <table width="100%" cellSpacing="0" cellPadding="0" border="0">
                ...
                <tbody>
                  {agreements?.map((agreement) => (
                    <>
                      {agreement.name.State === "in progress" && (
                        <OrdersRows agreement={agreement} />
                      )}
                    </>
                  ))}
                </tbody>
            ...
            {agreements?.map((agreement, index) => (
              <>
                {agreement.name.State === "buyer_initialized_and_paid" && (
                  <OrdersRows key={index} agreement={agreement} />
                )}
              </>
            ))}
          </div> */}
