...
import {UpdateJobToMoralisDB} from "../../../JS/DB-pushFunctions.js"
...
apiRoute.post(async (req, res) => {
  ...
  if(AnyEmpty([objectId, title, price, description, timeToDeliver])){ // seller,
  ...
  await UpdateJobToMoralisDB(objectId, title, price, description, timeToDeliver);
