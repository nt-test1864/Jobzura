...
import { UpdateContracts_StartDispute, UpdateNotifications, UpdateUserParticipationData } from '../../../JS/DB-pushFunctions';
...
apiRoute.post(async (req, res) => {
  ...
  if(AnyEmpty([BuyerWallet, SellerWallet, transactionHash, objectId])){
